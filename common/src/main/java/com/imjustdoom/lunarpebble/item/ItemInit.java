...
import com.imjustdoom.lunarpebble.item.custom.GlassPebble;
...
public class ItemInit {
    ...
    public static final RegistrySupplier<Item> GLASS_PEBBLE = ITEMS.register("glass_pebble", GlassPebble::new);
